...
class QuizQuestion : AppCompatActivity(), View.OnClickListener
{
    ...
    //private var testOptionOne: TextView? =null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // testOptionOne =findViewById(R.id.tv_optionOne)
       ...
       when(view?.id){
           ...
           R.id.btnSubmit -> {
               if (mSelectedOptionPostion == 0) {
                   ...
                   if (question!!.correctAns != mSelectedOptionPostion) {
                       answerView(mSelectedOptionPostion, R.drawable.wrong_option_bg)
                   }else{
                       mCorrectAnswers++
                   }
